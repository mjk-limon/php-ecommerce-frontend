...
?>
	...
	<div class="support-center">
		<div class="support-bg">				
			<h3 class="support-title">
				<img src="<?= Models::baseUrl('images/logo.png') ?>" alt="logo" />
						...
						<div class="support-quick-options">
							...
							<div class="sqo-cat">
								...
								<ul>
									...
									<li><a href="#"><i class="fa fa-angle-right"></i> I want to unsubscribe from <?= COMPANY_NAME ?> newsletter ?</a></li>
								</ul>
							</div>
							<div class="sqo-cat">
								<h4>Payment Related Issues</h4>
								<ul>
									<li><a href="#"><i class="fa fa-angle-right"></i> How do I pay on <?= COMPANY_NAME ?> ?</a></li>
						...
						<div class="support-more">
							...
							<div class="supm-box">
								<a href="#" class="newLiveChat">							
									<img src="<?= Models::baseUrl('images/headp.png') ?>" alt="" />
									Live Chat
								</a>
							</div>
							<div class="supm-box">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<iframe
							...
							src="https://www.google.com/maps/embed/v1/place?key=<?= GOOGLE_MAP_API ?>&q=<?= urlencode(Models::getContactInformation('address')); ?>" 
							allowfullscreen >
						</iframe>
					</div>
				</div>
	...
	<script src="<?= Models::baseUrl('assets/_ilm_own/js/supportPage_scripts.js') ?>"></script>
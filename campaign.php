...
use _ilmComm\ProductInfo\SingleProduct;

$sp = new SingleProduct;
$FlashSales = $this->flashDealProducts();
$FlashSaleTimer = $this->flashDealTimer();

?>

<section class="main-body">
    <?php if ($FlashSales->num_rows && $FlashSaleTimer) : ?>
        <div class="spd">
            <div class="container">
                <div class="section-mb">
                    <div class="ft-title">
                        <div class="ft-title-left">
                            ...
                            <div class="ft-timer">
                                <span class="fdt-timer">&#9673; Ends in <span id="fdl-timer" data-endin="<?= $FlashSaleTimer['end_in'] ?>">00:00:00</span></span>
                            </div>
                        </div>
                    ...
                    <div class="ft-pr-sliders">
                        <div <?= !$this->mobileView ? 'id="flashsale" style="position:relative;margin:0 auto;top:0px;left:0px;width:1349px;height:350px;overflow:hidden;visibility:hidden;"' : null ?>>
                            <div <?= !$this->mobileView ? 'data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1349px;height:350px;overflow:hidden;"' : 'class="m-flex ft-pr-mbl"' ?>>

                                <?php
                                while ($FsPr = $FlashSales->fetch_assoc()) :
                                    $sp->setPrInfo($FsPr);
                                    $sp->processDiscount();
                                    $sp->processStock();
                                ?>

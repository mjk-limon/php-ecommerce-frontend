...
?>
				...
				<div class="wrapper_main">
					<div class="section-mb login_registration_widget">
						...
						<form class="_ilmForm" id="registrationForm" action="" method="post">
							...
							<input type="hidden" class="refPage" name="ref" value="<?= $this->getReferences('url') ?>" />
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input class="form-control" name="password" pattern=".{6,}" type="password" 
											title="Password must be greater than 6 characters" placeholder="Password" required />
									</div>
									<div class="form-group">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										?>	
											<option value="<?= $Loc ?>" data-city="<?= $City ?>">
												<?= $Loc ?>
											</option> 
										<?php endwhile; ?>
									...
									<div class="checkbox">
										<label><input type="checkbox" checked name="nws" value="1">Subscribe email for <?= COMPANY_NAME ?>'s offer and promotions</label>
									</div>
							...
							<div class="swap-btn"><a href="/login/?ref=<?= urlencode($this->getReferences('key')) ?>">Already have an account? Login here.</a></div>
						</form>
					</div>
				</div>
			</div>
	...
	<script async src="<?= Models::asset('assets/_ilm_own/js/registerPage_scripts.js') ?>"></script>
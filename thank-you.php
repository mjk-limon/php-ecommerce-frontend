								...
								<table border="0" class="">
									<tbody>
										<tr>
											<td>Name</td>
											<td>:</td>
											<td><?= htmlspecialchars($OrderInfo->getName()) ?></td>
										</tr>
										<tr>
											<td>Mobile Number</td>
											<td>:</td>
											<td><?= htmlspecialchars($OrderInfo->getMobileNumber()) ?> </td>
										</tr>
										<tr>
											<td>Email</td>
											<td>:</td>
											<td><?= htmlspecialchars($OrderInfo->getEmail()) ?> </td>
										</tr>
										<tr>
											<td>Address</td>
											<td>:</td>
											<td><?= htmlspecialchars($OrderInfo->getAddress()) ?></td>
										</tr>
										<tr>
											<td>Delivery Type</td>
											<td>:</td>
											<td><?= $OrderInfo->getDeliveryType() ?></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<table border="0" class="">
									<tbody>
										<tr>
											...
											<td>:</td>
											<td><?= htmlspecialchars($OrderInfo->getDeliveryLocation()) ?></td>
										</tr>
										<tr>
											<td>Payment Type</td>
											<td>:</td>
											<td><?= $OrderInfo->getPaymentType() ?></td>
										</tr>
										<tr>
											<td>Payment Status</td>
											<td>:</td>
											<td><?= $OrderInfo->getPaymentStatus() ?></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<div class="col-md-6 col-sm-6 col-xs-6 invoice-info">
									<table border="0">
										...
										<tr>
											<td>Ordering Date</td>
											<td>:</td>
											<td><?= date("d-m-Y H:iA", strtotime($OrderInfo->getOrderDate())) ?> </td>
										</tr>
										<tr>
											<td>Currency</td>
											<td>:</td>
							...
							<div class="row invoice-table">
								<div class="col-md-12">
									...
									<table class="itemTotal" border="0">
										<tr>
											<td>Total</td>
											<td><?= Models::curr($Total) ?></td>
										</tr>
										<tr>
											<td>Delivery Cost</td>
											<td><?= Models::curr($DCost) ?></td>
										</tr>

										<?php if ($CouponDiscount) : ?>
											<tr>
												<td>Coupon Discount</td>
												<td><?= Models::curr($CouponDiscount) ?></td>
											</tr>
										<?php endif; ?>

										<tr class="subtotal">
											<td>Subtotal</td>
											<td><?= Models::curr($SubTotal) ?></td>
										</tr>
									</table>

    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9p5 col-md-9 slider-section">
                <div id="slider">
                    <div class="banner-slider" id="sliderb_container" style="position: relative;left: 0px; width: 1350px;height: 560px; overflow: hidden;">
                        <div u="slides" style="cursor: move; position: absolute;left: 0px;top: 0px; width:1350px; height: 560px;overflow: hidden;">

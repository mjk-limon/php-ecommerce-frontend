...
?>
			...
			<div class="section-mb login_registration_widget pd-0">			
				<div class="my-account">
					<div class="card hovercard">
						<div class="card-background"><img class="card-bkimg user-ppc" src="<?= Models::asset($UserInfo->getUserImage()) ?>"></div>
						<div class="useravatar"><img class="user-ppc" src="<?= Models::asset($UserInfo->getUserImage()) ?>"></div>
						<div class="card-info"><span class="card-title">Hi, <?= $UserInfo->getLastName() ?></span></div>
					</div>
	...
	<script defer type="text/javascript">
		$(document).ready(function(){
			$('.myac-nav a[href="<?= $SwtchTab ?>"]').tab('show');
			...
			$('#ppic-file-input').on('change', function(e){
				...
				}, null, {dataType:'text',cache:false,contentType:false,processData:false});

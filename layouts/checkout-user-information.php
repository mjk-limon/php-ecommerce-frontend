        ...
        <div class="row">
            <div class="col-md-6 checkout-login checkout-login-left">
                <div class="opt-login-form">
                    ...
                    <a href="javascript:;" class="swaplogin email">Login Using Email Address</a>
                </div>

                <div class="email-login-form limlog-form">
                    ...
                    <a href="javascript:;" class="swaplogin">Login Using Mobile Number</a>

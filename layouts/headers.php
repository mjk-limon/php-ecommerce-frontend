                            ...
                            <div class="row flex" style="align-items: center;">
                                ...
                                <div class="col-md-4 hidden-xs">
                                    <ul class="wishlistall">
                                        <?php if ($this->UserData) : ?>
                                            <li class="dropdown">
                                                <a href="javascript:;" class="useraccount loggedin" data-toggle="dropdown">
                                                    Welcome,
                                                    <h5><?php echo $this->UserData['first_name'] ?></h5>
												</a>
                                        ...
                                        <?php else : ?>
                                            <li>
                                                <a href="/my-account/" class="useraccount">
													Welcome,
                                                    <h5>Sign In Or Join Free</h5>
												</a>
                                            </li>
                                        <?php endif; ?>

                                        <li>
                                            <a href="/contact/" class="useraccount">
                                                Help
                                                <h5>& Support</h5>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/cart/">
                                                <div class="ht-cart flex">
                                                    <div class="ht-cart-left">
                                                        <i class="fa fa-shopping-cart"></i>
                                                    </div>
                                                    <div class="ht-cart-right">
                                                        Cart,
                                                        <h5><span id="fcTot"><?= $this->CartData->getTotalItem() ?></span> total</h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>

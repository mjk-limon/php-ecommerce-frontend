...
<head>
    ...
    <link rel="icon" href="<?= Models::asset("favicon.png") ?>">
    ...
    <script>
        ...
        chatbox.setAttribute("page_id", "110608451118188");
            ...
            <div class="container">
                <div class="row flex branding-flex deskv-hm">
                    <div class="col-md-3 col-xs-5 cols logo-cols">
                        <div class="logo">
                            <a href="/" id="home-btn"><img src="<?= Models::asset("images/logo.svg") ?>"></a>
                        </div>
                    </div>
                            ...
                            <ul class="ht-right">
                                ...
                                <li class="dropdown ht-top-shortcut">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right animated slideDown">
                                        ...
                                        <li><a href="/search/?q=?q=&a_s_t=special_offer"><?= $this->OfferText ?></a></li>

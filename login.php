						...
						<div class="row">
							<div class="col-md-6 col-xs-12">
								<form class="_ilmForm" id="loginForm" action="" method="POST">
									...
									<div class="swap-btn"><a href="/register/?ref=<?= urlencode($this->getReferences('key')) ?>">Create new account</a></div>
								</form>
							</div>
							<div class="col-md-6 col-xs-12">
                            <?php ?>
...
<script defer src="<?= Models::asset('assets/_ilm_own/js/loginPage_scripts.js') ?>"></script>